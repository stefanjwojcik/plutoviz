...
using RCall, TimeSeries, MarketData, Plots, CSV, DataFrames, Statistics, StateSpaceModels, PlutoUI

# ╔═╡ aedc1f34-6909-44b7-9dd9-fc47b15f51f5
pwd()

# ╔═╡ 31dce6e4-f560-4276-a8ee-ddf22575e13f
...
md"""
This is a template for a Data Science analysis or report 
"""
...
# ╔═╡ ffcc4490-52cc-4d03-b077-ecdbf839ec2e
md""" ## Loading Data """
...
# ╔═╡ a3f82340-d5a0-49a7-8ee5-4778d2aecace
plot(log.(values(ngr.price)[end-(25*5):end]), title = "Day Ahead Price", ylabel = "Price", xlabel = "t")

# ╔═╡ cfb2be1e-a5b7-4509-8d99-06bbf4a9fd69
plot_cma(ngr.price[end-400:end], 24)
